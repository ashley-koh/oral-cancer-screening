...
const labels = [
  {
    linkName: "buccal-mucosa",
    text: "Buccal Mucosa",
    position: { x: 2, y: 4, z: 0.5 },
  },
  {
    linkName: "sublingual-mucosa",
    text: "Sublingual",
...
loader.load(
  ...
  function (gltf) {
    ...
    gltf.scene.position.x += gltf.scene.position.x - 2;
      ...
      function route(e) {
        if (!moved) {
          if (config === "production") {
            location.href =
              "https://ashley-koh.github.io/oral-cancer-screening/pages/specifics/" +
              selectedObject.name +
              "/index.html";
          } else {
            location.href =
              "/pages/specifics/" + selectedObject.name + "/index.html";
          }
        }
      }
    }
