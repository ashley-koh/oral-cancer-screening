const labels = [{
    linkName: 'hard-palate',
    text: 'Hard Palate',
    position: { x: 0.1, y: 1.5, z: 0.2 }
  },{
    linkName: 'soft-palate',
    text: 'Soft Palate',
...
loader.load('upper_mouth.glb', function ( gltf ) {
...
if ( intersects.length > 0 ) {
  ...
  if ( res && res.object ) {
    ...
    function route(e) {
      if (!moved) {
        // location.href = 'https://ashley-koh.github.io/oral-cancer-screening/pages/upper-mouth' + selectedObject.name + '/index.html';
        location.href = '/pages/upper-mouth/' + selectedObject.name + '/index.html';
      }
    }
  }
