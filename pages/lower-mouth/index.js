const labels = [
  {
    linkName: "floor-of-mouth",
    text: "Floor of Mouth",
    position: { x: 0, y: -0.9, z: 1 },
  },
  {
    linkName: "retro-molar-pad",
    text: "Retro-Molar Pad",
    position: { x: 1.7, y: 1.1, z: 0.5 },
  },
  {
    linkName: "retro-molar-pad",
    text: "Retro-Molar Pad",
      ...
      function route(e) {
        if (!moved) {
          if (config === "production") {
            location.href =
              "https://ashley-koh.github.io/oral-cancer-screening/pages/lower-mouth/" +
              selectedObject.name +
              "/index.html";
          } else {
            location.href =
              "/pages/lower-mouth/" + selectedObject.name + "/index.html";
          }
        }
      }
    }
